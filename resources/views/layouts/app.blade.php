                        ...
                        <center>
                            ...
                            <form>
                                <div class="form-group">
                                    <input type="text" name="name" class="text-center col-sm-6 col-xs-6 form-control is-invalid" placeholder="nama" required autofocus>
                                </div>
                                <div class="form-group">
                                    <input type="email" name="email" class="text-center col-sm-6 col-xs-6 form-control is-invalid" placeholder="email" required>
                                </div>
                                <div class="form-group">
                                    <input type="number" name="phone_number" class="text-center col-sm-6 col-xs-6 form-control is-invalid" placeholder="nomor handphone" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="voucher_code" class="text-center col-sm-6 col-xs-6 form-control is-invalid" placeholder="kode voucher*">
